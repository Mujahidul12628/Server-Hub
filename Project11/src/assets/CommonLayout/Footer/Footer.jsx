...
const Footer = () => {
    return (
        <div className="text-white p-10 footer-bg">
            <div className="w-full max-w-6xl mx-auto gap-10 justify-between items-start grid grid-cols-2   sm:grid-cols-2 md:grid-cols-4">
                <div className='About-us max-w-xs text-justify flex flex-col gap-2'>
                    <h3 className='text-start'><img className="h-[45%] w-[45%] object-contain sm:h-[35%] sm:w-[35%] md:h-[50%] md:w-[50%] lg:h-[40%] lg:w-[40%] xl:h-[35%] xl:w-[35%]" src={logo} alt="" /></h3>
